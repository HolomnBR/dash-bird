...
class ApiManager {
  constructor() {
    ...
    // Log do caminho da API para debug
    console.log('🔍 Caminho da API configurado:', this.apiExePath);
  ...
  async startApi() {
    ...
    if (!fs.existsSync(this.apiExePath)) {
      throw new Error(`Executável da API não encontrado: ${this.apiExePath}`);
    }
